...
public class FXMLController {
    ...
    void doCreaGrafo(ActionEvent event) {
    	...
    	if(p==null) {
    		txtResult.appendText("seleziona un provider per creare il grafo");
    		return;
    	}
    	String result=this.model.creaGrafo(p);
    	txtResult.appendText(result+"\n");
    	cmbQuartiere.getItems().clear();
    	cmbQuartiere.getItems().setAll(this.model.getQuartieri());
    }
    ...
    void doQuartieriAdiacenti(ActionEvent event) {
    	...
    	List<CityDistance> result =this.model.quartieriAdiacenti(q);
    ...
    void initialize() {
        ...
        clQuartiere.setCellValueFactory(new PropertyValueFactory<CityDistance, String>("citta"));
